...
void formulario_libro(struct libreria libros[1000], int *p_contadorlibros, int conta_dupli[100000],int *p_contaLibroD, int *p_diaActual, int *p_mesActual, int *p_annoActual){
	int codigo_libro, bandera = 1;
	//aqui continuamis mañana
	for(int i=0; i< 100000; i++){
		conta_dupli[i] = 1;
	}		
	int i = 0;
...
//			p_contaLibroD[libros[i].codigoLibro] = conta_dupli[libros[i].codigoLibro];	
//			printf("%d", p_contaLibroD[libros[i].codigoLibro]);
//		}	
//		bandera = 0;
//	}
//	getch();
...
//			   *p_mesActual, 
//			   *p_annoActual);					
//		printf("Cantidad de libros %d\n", p_contaLibroD[libros[i].codigoLibro]);
//		i = i + conta_dupli[libros[i].codigoLibro];
//	}while(i < *p_contadorlibros);
//	printf("Ingrese el codigo del libro que desea llevar: ");
//	scanf("%d", &codigo_libro);
//	for(int i = 0; i < *p_contadorlibros; i++){
//		
//	}
//	if(codigo_libro == libros[])
	getch();
	system("cls");
}
						...
						if(res2 == 0){
							...
							do{
								...
								switch(seleccionMenu){
									...
									case 3:{
										formulario_libro(libros, p_contadorlibros, conta_dupli,p_contaLibroD, p_diaActual, p_mesActual, p_annoActual);
										break;
									}
									case 4:{
											do{
