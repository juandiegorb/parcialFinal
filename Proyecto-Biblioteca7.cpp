	...
	for(int i=0; i< *p_contadorlibros; i++){
		for(int j=i+1; j<*p_contadorlibros; j++){
			if(libros[i].codigoLibro == libros[j].codigoLibro){
				...
				// aux fecha prestamo
				aux.auxDiaPrestamo = libros[i+1].diaPrestamo;
				aux.auxMesPrestamo = libros[i+1].mesPrestamo;
				aux.auxAnnoPrestamo = libros[i+1].annoPrestamo;
				// aux fecha devolucion
				...
				libros[i+1].diaPrestamo = libros[j].diaPrestamo;
				libros[i+1].mesPrestamo = libros[j].mesPrestamo;
				libros[i+1].annoPrestamo = libros[j].annoPrestamo;
				...
				libros[j].diaPrestamo = aux.auxDiaPrestamo;
				libros[j].mesPrestamo = aux.auxMesPrestamo;
				libros[j].annoPrestamo = aux.auxAnnoPrestamo;
...
void libros_antiguos(struct libreria libros[1000], int *p_contadorlibros){
...
void menus(struct libreria libros[1000], struct auxiliar aux){
	...
	*p_contadorlibros = 50;
	...
	libros_antiguos(libros, p_contadorlibros);
								...
								switch(seleccionMenu){
									...
									case 2:{
										...
										*p_contaNuevos = 0;								
										...
										contador(libros, p_contadorlibros, conta_dupli, diaActual, mesActual, annoActual);
