...
void menus(struct libreria libros[1000], struct auxiliar aux){
	//Variables
	int seleccionLogin, seleccionMenu, seleccionConsulta, contadorLibros, diaActual, mesActual, annoActual, id = 51, contaViejos, contaNuevos/*, conta_dupli[1000000]*/;
